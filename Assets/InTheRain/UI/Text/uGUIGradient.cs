            ...
            case Type.Vertical:
                {
                    ...
                    for (int i = nCount - 1; i >= 0; --i)
                    {
                        ...
                        uiVertex.color = gradient.Evaluate(1f-(uiVertex.position.y - fBottomY) * fUIElementHeight - Offset);
            ...
            case Type.Horizontal:
                {
                    ...
                    {
                        UIVertex uiVertex = _vertexList[i];
                        uiVertex.color = gradient.Evaluate((uiVertex.position.x - fLeftX) * fUIElementWidth - Offset);
                        _vertexList[i] = uiVertex;
                    }
                }
                break;
